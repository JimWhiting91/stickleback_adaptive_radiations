...
# # Visualise
# ggplot(recomb_windows[recomb_windows$chr=="groupI",],aes(x=rowMeans(recomb_windows[recomb_windows$chr=="groupI",c("BP1","BP2")]),y=recomb))+
#   geom_line()+
#   geom_vline(xintercept=c(21550000,21800000))+
#   xlim(c(20000000,25000000))
