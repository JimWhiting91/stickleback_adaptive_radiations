...
lib<-as.vector(c("dplyr","data.table","ggplot2","ggpubr"))
...
# All together
PC_plots<-ggarrange(shape_project,env_plot,armour_project,gill_plot,
                    ncol=2,nrow=2,common.legend = T)
pdf("figs/Figure4b_All_PCAs_and_projections.pdf",width=6,height=7)
PC_plots
dev.off()
